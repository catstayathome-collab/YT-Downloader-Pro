...
enum L10n {
    ...
    enum Key: String, CaseIterable, Sendable {
        ...
        case confirmationClearCompletedButton = "confirmation.clearCompleted.button"
        case confirmationClearCompletedMessage = "confirmation.clearCompleted.message"
        case confirmationClearCompletedTitle = "confirmation.clearCompleted.title"
        ...
        case downloadCenterBulkClearCompleted = "downloadCenter.bulk.clearCompleted"
